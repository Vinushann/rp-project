...
function NandikaPage() {
  ...
  const generatePDF = (statistics, mode, additionalInfo = {}) => {
    ...
    doc.text("SentiPulse", pageWidth / 2, yPos, {
      align: "center",
    });
    yPos += 10;
    ...
    for (let i = 1; i <= pageCount; i++) {
      ...
      doc.text(
        `Page ${i} of ${pageCount} | Generated by SentiPulse`,
        pageWidth / 2,
    ...
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl flex items-center justify-center text-white font-bold text-sm shadow-lg">
            SP
          </div>
          <div>
            ...
            <p className="text-gray-500">Multilingual Sentiment Analyzer</p>
          </div>
        </div>
