...
- `VinushanPage.jsx` - Main page component (EDIT THIS)
- Add more files as needed (e.g., `components/`, `hooks/`, `utils/`)

## Route
Your module page is available at `/vinushan`

## How to customize
1. Open `VinushanPage.jsx`
...
- `GET /api/v1/vinushan/ping` - via PingButton component
- `POST /api/v1/vinushan/chat` - via ChatBox component
...
// In your component:
const response = await fetch('/api/v1/vinushan/your-endpoint');
```
