...
const tabs = [
  ...
  { id: 'quality', label: 'Data Quality', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <ExportButtons datasetName={results.dataset_name} />
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        ...
        <div className="p-6">
          ...
          {activeTab === 'dashboard' && (
            <DashboardEnhanced results={results} />
          )}
          ...
          {activeTab === 'quality' && (
            <DataQuality datasetName={results.dataset_name} />
          )}

          {activeTab === 'anomalies' && (
            <AnomalyDetection datasetName={results.dataset_name} />
          )}

          {activeTab === 'compare' && (
            <ComparativeAnalysis datasetName={results.dataset_name} />
          )}
