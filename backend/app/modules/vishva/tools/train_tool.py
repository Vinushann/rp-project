...
class MenuCategoryClassifier:
    ...
    def apply_feature_selection(self, X_train, X_test, y_train, method: str, n_features: int = 500):
        ...
        # Dynamic feature count based on data size
        n_features = min(n_features, X_train.shape[1] - 1, X_train.shape[0] // 2)
        n_features = max(10, n_features) # At least 10
